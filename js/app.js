...
var waypoint = new Waypoint({
  ...
  handler: function() {
    ...
    p[6].setAttribute("style", "width:85%;transition:2.5s all;");
    p[7].setAttribute("style", "width:90%;transition:2.5s all;");
...
//   });
  ...
  strings: ["LALIT SINGH", "A Web Developer"," An App Developer"," A Graphic Designer"],
  smartBackspace: true,
   typeSpeed: 100,
   backSpeed: 100,
   loop: true,
